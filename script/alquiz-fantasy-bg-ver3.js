...
class FantasyQuiz extends GamifiedQuiz {
    ...
    init() {
        ...
        */
        ...
        badgeMana.onclick = function() {
            ...
            let textPassagePre = document.createElement("span"); textPassagePre.innerHTML = "W&auml;hle ";
            let textPassagePost = document.createElement("span"); textPassagePost.innerHTML = " , zu dem du dich teleportieren m&ouml;chtest.";
        ...
        let options = [
            ...
            {text:"Zur&uuml;ck", func:funcClose}
        ];
        ...
        let creditsBackButton = this.createSettingsOptionsContainer("Zur&uuml;ck", function() { this.closest(".fantasy-modal").classList.remove("active"); object.settingsModal.classList.add("active"); });
        ...
        modal.appendChild(this.createSettingsOptionsContainer("Zur&uuml;ck"));
    ...
    teleportDialog(object, questionId, neededMana) {
        ...
        if(!object.finished) {
            manaPhrase = " f&uuml;r "+neededMana+" Energiepunkte ";
        }
        if(questionId == undefined) {
            nextEnemyPhrase = " zum n&auml;chsten Gegner ";
        }
        else {
        ...
        confirmLink.onclick = function() {
            if(neededMana == 0 || object.finished == true) {
                ...
                object.processNotification("Du hast nicht genug Energiepunkt, um "+nextEnemyPhrase+" zu springen. Besiege zun&auml;chst andere Gegner.", true);
            }
        };
    ...
    pseudoEverythingBackToStart() {
        ...
        if(currentVisibleEnemies == undefined || currentVisibleEnemies.length == 1) {
            ...
            prePhrase = "W&auml;hle deinen Gegner (klick) und f"
        }
        this.notificationBubbleContainer.querySelector(".bubble-content").innerHTML = prePhrase+"&uuml;hre deinen Zauber aus (Enter oder klick auf die Formel), um die Fee zur&uuml;ckzuverwandeln.";
    ...
    animateIntro() {
        ...
        skipLink.innerHTML = "&uuml;berspringen";
        skipLink.href = "javascript:;";
        skipLink.onclick = function() {
            object.introCleanUp();
            object.processNotification("Klicke auf den Wegweiser (rechts), um loszulegen. Verwandle die Monster zur&uuml;ck in Feen, indem du die R&auml;tsel l&ouml;st und komme dem Geheimnis auf die Spur, indem du das Ziel erreichst.", true);
        };
        ...
        this.processNotification("Hey, es ist etwas Schreckliches passiert. Bitte h&ouml;r mir zu. ", false, undefined, undefined, actionSpace, false);
    ...
    resetFairyBubbleToDefault() {
        ...
        object.notificationBubbleContainer.querySelector(".bubble-content").innerHTML = "Von hier aus kannst du <a href=\"javascript:void(0);\" onclick=\"ALQuiz.goToNextScene();\">zum n&auml;chsten Gegner gehen</a> oder dich "+optionTeleportPhrase+".";
    }
                ...
                object.GameElements.helper.node.addEventListener("animationend", function() {
                    ...
                    if(completelySolved == false) {
                        ...
                        if(object.solvedVariants == undefined || object.solvedVariants.length == 0) {
                            preText = "Nutze das Textfeld, um deinen Zauber zu formulieren und klicke auf die Formel, um ihn auszuf&uuml;ren. Oder benutze die Enter-Taste.";
                            ...
                            if(!object.solvedVariants.some(r => multipleMonstersVariants.indexOf(r) >= 0)) {
                                ...
                                preText = "Ziele auf das Monster, das du verwandeln m&ouml;chtest, indem du es anklickst.";
                                /*object.GameElements.helper.node.addEventListener("animationend", function() {
                                    videoAnimation = false;
                                }, {once:true});*/
                            }
            ...
            setTimeout(function() {    
                ...
                if(completelySolvedBefore) {
                    ...
                    if(completelySolved == true) {
                        ...
                        message = "Danke, dass du mich gerettet hast! Bitte, bevor du tiefer in den Wald gehst, verwandle auch meine Freunde zur&uuml;ck! ("+currQuestion.solvedVariants.length+" von "+currQuestion.variants+")";
